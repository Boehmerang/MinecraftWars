...
public class mcWarsContainerPlayer extends ContainerPlayer
{

	public mcWarsContainerPlayer(InventoryPlayer par1InventoryPlayer, boolean par2, EntityPlayer par3EntityPlayer) 
	{
		super(par1InventoryPlayer, par2, par3EntityPlayer);
		 ...
		 this.inventoryItemStacks.clear();
	        ...
	        for (i = 0; i < 4; ++i)
	        {
	            this.addSlotToContainer(new Slot(par1InventoryPlayer, par1InventoryPlayer.getSizeInventory() - 1 - i - 5, 8, 8 + i * 18));
	        }
